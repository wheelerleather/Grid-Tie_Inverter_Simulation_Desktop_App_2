...
class WaveformWidget(QWidget):
    ...
    def get_plot_title(self, phase=None):
        if self.multilevel_topology == "None" and self.mppt == "None":
            return f"{phase} Waveforms" if phase else "Inverter Output Waveforms"
        return f"{phase} Waveforms ({self.multilevel_topology}, {self.pwm_technique}, {self.design}, {self.mppt})" if phase else f"Inverter Output Waveforms ({self.multilevel_topology}, {self.pwm_technique}, {self.design}, {self.mppt})"
