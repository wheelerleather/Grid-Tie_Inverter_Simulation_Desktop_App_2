...
class ControlPanel(QWidget):
    ...
    launch_grid = pyqtSignal()  # New signal for launching grid simulation
    ...
    def init_ui(self):
        ...
        self.grid_button.clicked.connect(self.launch_grid.emit)  # Connect new button
    ...
    def getStyleSheet(self):
        return """
            ...
            QPushButton#tds_button, QPushButton#fsa_button, QPushButton#grid_button, QPushButton#export_all_button {
                font-family: 'Consolas';
                font-size: 12pt;
            }
            QLabel {
